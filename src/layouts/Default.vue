    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:uelsmall08@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/uelSmall" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/azdrian" target="_blank" class="text-white hover:text-gray-400">
